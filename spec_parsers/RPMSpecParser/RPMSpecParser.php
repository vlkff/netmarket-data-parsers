...
class RPMSpecParser extends NumericSpecParser {

    // These two attributes defines key of base_spec table and category id's the parser class is applicable to.
    static public $keys = array('Скорость вращения', 'Макс. частота вращения диска');
    static public $categories = array();

    protected $knownMeasures = array('об/мин');

    protected $measures = array(
        'об/мин' => array('об\/мин', 'rpm', 'дв\.\/мин'),
    );
